fn eval_composition_polynomial_inner(
	...
	let column0_row28 = *mask_values.pop_front().unwrap();
	let column0_row44 = *mask_values.pop_front().unwrap();
	let column0_row60 = *mask_values.pop_front().unwrap();
	let column0_row76 = *mask_values.pop_front().unwrap();
	let column0_row92 = *mask_values.pop_front().unwrap();
	let column0_row108 = *mask_values.pop_front().unwrap();
	let column0_row124 = *mask_values.pop_front().unwrap();
	...
	let column1_row7 = *mask_values.pop_front().unwrap();
	...
	let column1_row15 = *mask_values.pop_front().unwrap();
	...
	let column6_row256 = *mask_values.pop_front().unwrap();
	let column6_row511 = *mask_values.pop_front().unwrap();
	let column7_row0 = *mask_values.pop_front().unwrap();
	let column7_row1 = *mask_values.pop_front().unwrap();
	let column7_row255 = *mask_values.pop_front().unwrap();
	let column7_row256 = *mask_values.pop_front().unwrap();
	let column8_row0 = *mask_values.pop_front().unwrap();
	let column8_row1 = *mask_values.pop_front().unwrap();
	let column8_row192 = *mask_values.pop_front().unwrap();
	let column8_row193 = *mask_values.pop_front().unwrap();
	let column8_row196 = *mask_values.pop_front().unwrap();
	let column8_row197 = *mask_values.pop_front().unwrap();
	let column8_row251 = *mask_values.pop_front().unwrap();
	let column8_row252 = *mask_values.pop_front().unwrap();
	let column8_row256 = *mask_values.pop_front().unwrap();
	let column9_row0 = *mask_values.pop_front().unwrap();
	let column9_row1 = *mask_values.pop_front().unwrap();
	let column9_row255 = *mask_values.pop_front().unwrap();
	let column9_row256 = *mask_values.pop_front().unwrap();
	let column9_row511 = *mask_values.pop_front().unwrap();
	let column10_row0 = *mask_values.pop_front().unwrap();
	let column10_row1 = *mask_values.pop_front().unwrap();
	let column10_row255 = *mask_values.pop_front().unwrap();
	let column10_row256 = *mask_values.pop_front().unwrap();
	let column11_row0 = *mask_values.pop_front().unwrap();
	let column11_row1 = *mask_values.pop_front().unwrap();
	let column11_row192 = *mask_values.pop_front().unwrap();
	let column11_row193 = *mask_values.pop_front().unwrap();
	let column11_row196 = *mask_values.pop_front().unwrap();
	let column11_row197 = *mask_values.pop_front().unwrap();
	let column11_row251 = *mask_values.pop_front().unwrap();
	let column11_row252 = *mask_values.pop_front().unwrap();
	let column11_row256 = *mask_values.pop_front().unwrap();
	let column12_row0 = *mask_values.pop_front().unwrap();
	let column12_row1 = *mask_values.pop_front().unwrap();
	let column12_row255 = *mask_values.pop_front().unwrap();
	let column12_row256 = *mask_values.pop_front().unwrap();
	let column12_row511 = *mask_values.pop_front().unwrap();
	let column13_row0 = *mask_values.pop_front().unwrap();
	let column13_row1 = *mask_values.pop_front().unwrap();
	let column13_row255 = *mask_values.pop_front().unwrap();
	let column13_row256 = *mask_values.pop_front().unwrap();
	let column14_row0 = *mask_values.pop_front().unwrap();
	let column14_row1 = *mask_values.pop_front().unwrap();
	let column14_row192 = *mask_values.pop_front().unwrap();
	let column14_row193 = *mask_values.pop_front().unwrap();
	let column14_row196 = *mask_values.pop_front().unwrap();
	let column14_row197 = *mask_values.pop_front().unwrap();
	let column14_row251 = *mask_values.pop_front().unwrap();
	let column14_row252 = *mask_values.pop_front().unwrap();
	let column14_row256 = *mask_values.pop_front().unwrap();
	let column15_row0 = *mask_values.pop_front().unwrap();
	let column15_row255 = *mask_values.pop_front().unwrap();
	let column16_row0 = *mask_values.pop_front().unwrap();
	let column16_row255 = *mask_values.pop_front().unwrap();
	let column17_row0 = *mask_values.pop_front().unwrap();
	let column17_row255 = *mask_values.pop_front().unwrap();
	let column18_row0 = *mask_values.pop_front().unwrap();
	let column18_row255 = *mask_values.pop_front().unwrap();
	let column19_row0 = *mask_values.pop_front().unwrap();
	let column19_row1 = *mask_values.pop_front().unwrap();
	let column19_row2 = *mask_values.pop_front().unwrap();
	let column19_row3 = *mask_values.pop_front().unwrap();
	let column19_row4 = *mask_values.pop_front().unwrap();
	let column19_row5 = *mask_values.pop_front().unwrap();
	let column19_row6 = *mask_values.pop_front().unwrap();
	let column19_row7 = *mask_values.pop_front().unwrap();
	let column19_row8 = *mask_values.pop_front().unwrap();
	let column19_row9 = *mask_values.pop_front().unwrap();
	let column19_row12 = *mask_values.pop_front().unwrap();
	let column19_row13 = *mask_values.pop_front().unwrap();
	let column19_row16 = *mask_values.pop_front().unwrap();
	let column19_row22 = *mask_values.pop_front().unwrap();
	let column19_row23 = *mask_values.pop_front().unwrap();
	let column19_row38 = *mask_values.pop_front().unwrap();
	let column19_row39 = *mask_values.pop_front().unwrap();
	let column19_row70 = *mask_values.pop_front().unwrap();
	let column19_row71 = *mask_values.pop_front().unwrap();
	let column19_row102 = *mask_values.pop_front().unwrap();
	let column19_row103 = *mask_values.pop_front().unwrap();
	let column19_row134 = *mask_values.pop_front().unwrap();
	let column19_row135 = *mask_values.pop_front().unwrap();
	let column19_row167 = *mask_values.pop_front().unwrap();
	let column19_row199 = *mask_values.pop_front().unwrap();
	let column19_row230 = *mask_values.pop_front().unwrap();
	let column19_row263 = *mask_values.pop_front().unwrap();
	let column19_row295 = *mask_values.pop_front().unwrap();
	let column19_row327 = *mask_values.pop_front().unwrap();
	let column19_row391 = *mask_values.pop_front().unwrap();
	let column19_row423 = *mask_values.pop_front().unwrap();
	let column19_row455 = *mask_values.pop_front().unwrap();
	let column19_row4118 = *mask_values.pop_front().unwrap();
	let column19_row4119 = *mask_values.pop_front().unwrap();
	let column19_row8214 = *mask_values.pop_front().unwrap();
	let column20_row0 = *mask_values.pop_front().unwrap();
	let column20_row1 = *mask_values.pop_front().unwrap();
	let column20_row2 = *mask_values.pop_front().unwrap();
	let column20_row3 = *mask_values.pop_front().unwrap();
	let column21_row0 = *mask_values.pop_front().unwrap();
	let column21_row1 = *mask_values.pop_front().unwrap();
	let column21_row2 = *mask_values.pop_front().unwrap();
	let column21_row3 = *mask_values.pop_front().unwrap();
	let column21_row4 = *mask_values.pop_front().unwrap();
	let column21_row5 = *mask_values.pop_front().unwrap();
	let column21_row6 = *mask_values.pop_front().unwrap();
	let column21_row7 = *mask_values.pop_front().unwrap();
	let column21_row8 = *mask_values.pop_front().unwrap();
	let column21_row9 = *mask_values.pop_front().unwrap();
	let column21_row10 = *mask_values.pop_front().unwrap();
	let column21_row11 = *mask_values.pop_front().unwrap();
	let column21_row12 = *mask_values.pop_front().unwrap();
	let column21_row13 = *mask_values.pop_front().unwrap();
	let column21_row14 = *mask_values.pop_front().unwrap();
	let column21_row15 = *mask_values.pop_front().unwrap();
	let column21_row16 = *mask_values.pop_front().unwrap();
	let column21_row17 = *mask_values.pop_front().unwrap();
	let column21_row21 = *mask_values.pop_front().unwrap();
	let column21_row22 = *mask_values.pop_front().unwrap();
	let column21_row23 = *mask_values.pop_front().unwrap();
	let column21_row24 = *mask_values.pop_front().unwrap();
	let column21_row25 = *mask_values.pop_front().unwrap();
	let column21_row30 = *mask_values.pop_front().unwrap();
	let column21_row31 = *mask_values.pop_front().unwrap();
	let column21_row39 = *mask_values.pop_front().unwrap();
	let column21_row47 = *mask_values.pop_front().unwrap();
	let column21_row55 = *mask_values.pop_front().unwrap();
	let column21_row4081 = *mask_values.pop_front().unwrap();
	let column21_row4083 = *mask_values.pop_front().unwrap();
	let column21_row4089 = *mask_values.pop_front().unwrap();
	let column21_row4091 = *mask_values.pop_front().unwrap();
	let column21_row4093 = *mask_values.pop_front().unwrap();
	let column21_row4102 = *mask_values.pop_front().unwrap();
	let column21_row4110 = *mask_values.pop_front().unwrap();
	let column21_row8167 = *mask_values.pop_front().unwrap();
	let column21_row8177 = *mask_values.pop_front().unwrap();
	let column21_row8179 = *mask_values.pop_front().unwrap();
	let column21_row8183 = *mask_values.pop_front().unwrap();
	let column21_row8185 = *mask_values.pop_front().unwrap();
	let column21_row8187 = *mask_values.pop_front().unwrap();
	let column21_row8191 = *mask_values.pop_front().unwrap();
	let column22_row0 = *mask_values.pop_front().unwrap();
	let column22_row16 = *mask_values.pop_front().unwrap();
	let column22_row80 = *mask_values.pop_front().unwrap();
	let column22_row144 = *mask_values.pop_front().unwrap();
	let column22_row208 = *mask_values.pop_front().unwrap();
	let column22_row8160 = *mask_values.pop_front().unwrap();
	let column23_inter1_row0 = *mask_values.pop_front().unwrap();
	let column23_inter1_row1 = *mask_values.pop_front().unwrap();
	let column24_inter1_row0 = *mask_values.pop_front().unwrap();
	let column24_inter1_row2 = *mask_values.pop_front().unwrap();
	
	// Compute intermediate values.
	let cpu__decode__opcode_range_check__bit_0 = column1_row0 - (column1_row1 + column1_row1);
	let cpu__decode__opcode_range_check__bit_2 = column1_row2 - (column1_row3 + column1_row3);
	let cpu__decode__opcode_range_check__bit_4 = column1_row4 - (column1_row5 + column1_row5);
	let cpu__decode__opcode_range_check__bit_3 = column1_row3 - (column1_row4 + column1_row4);
	...
	let cpu__decode__opcode_range_check__bit_5 = column1_row5 - (column1_row6 + column1_row6);
	let cpu__decode__opcode_range_check__bit_6 = column1_row6 - (column1_row7 + column1_row7);
	let cpu__decode__opcode_range_check__bit_9 = column1_row9 - (column1_row10 + column1_row10);
	...
	let cpu__decode__opcode_range_check__bit_7 = column1_row7 - (column1_row8 + column1_row8);
	let cpu__decode__opcode_range_check__bit_8 = column1_row8 - (column1_row9 + column1_row9);
	...
	let cpu__decode__opcode_range_check__bit_12 = column1_row12 - (column1_row13 + column1_row13);
	let cpu__decode__opcode_range_check__bit_13 = column1_row13 - (column1_row14 + column1_row14);
	let cpu__decode__fp_update_regular_0 = 1 - (cpu_decode_opcode_range_check_bit_12 + cpu_decode_opcode_range_check_bit_13);
	let cpu__decode__opcode_range_check__bit_1 = column1_row1 - (column1_row2 + column1_row2);
	let npc_reg_0 = column19_row0 + cpu_decode_opcode_range_check_bit_2 + 1;
	let cpu__decode__opcode_range_check__bit_10 = column1_row10 - (column1_row11 + column1_row11);
	let cpu__decode__opcode_range_check__bit_11 = column1_row11 - (column1_row12 + column1_row12);
	let cpu__decode__opcode_range_check__bit_14 = column1_row14 - (column1_row15 + column1_row15);
	let memory__address_diff_0 = column20_row2 - column20_row0;
	let range_check16__diff_0 = column2_row1 - column2_row0;
	...
	let pedersen__hash1__ec_subset_sum__bit_0 = column8_row0 - (column8_row1 + column8_row1);
	let pedersen__hash1__ec_subset_sum__bit_neg_0 = 1 - pedersen_hash1_ec_subset_sum_bit_0;
	let pedersen__hash2__ec_subset_sum__bit_0 = column11_row0 - (column11_row1 + column11_row1);
	let pedersen__hash2__ec_subset_sum__bit_neg_0 = 1 - pedersen_hash2_ec_subset_sum_bit_0;
	let pedersen__hash3__ec_subset_sum__bit_0 = column14_row0 - (column14_row1 + column14_row1);
	let pedersen__hash3__ec_subset_sum__bit_neg_0 = 1 - pedersen_hash3_ec_subset_sum_bit_0;
	let range_check_builtin__value0_0 = column0_row12;
	let range_check_builtin__value1_0 = range_check_builtin_value0_0 * global_values.offset_size + column0_row28;
	let range_check_builtin__value2_0 = range_check_builtin_value1_0 * global_values.offset_size + column0_row44;
	let range_check_builtin__value3_0 = range_check_builtin_value2_0 * global_values.offset_size + column0_row60;
	let range_check_builtin__value4_0 = range_check_builtin_value3_0 * global_values.offset_size + column0_row76;
	let range_check_builtin__value5_0 = range_check_builtin_value4_0 * global_values.offset_size + column0_row92;
	let range_check_builtin__value6_0 = range_check_builtin_value5_0 * global_values.offset_size + column0_row108;
	let range_check_builtin__value7_0 = range_check_builtin_value6_0 * global_values.offset_size + column0_row124;
	let ecdsa__signature0__doubling_key__x_squared = column21_row6 * column21_row6;
	let ecdsa__signature0__exponentiate_generator__bit_0 = column21_row15 - (column21_row47 + column21_row47);
	let ecdsa__signature0__exponentiate_generator__bit_neg_0 = 1 - ecdsa_signature0_exponentiate_generator_bit_0;
	let ecdsa__signature0__exponentiate_key__bit_0 = column21_row5 - (column21_row21 + column21_row21);
	...
	let value = (column19_row1 - (((column1_row0 * global_values.offset_size + column0_row4) * global_values.offset_size + column0_row8) * global_values.offset_size + column0_row0)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column19_row8 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_0 * column21_row8 + (1 - cpu_decode_opcode_range_check_bit_0) * column21_row0 + column0_row0)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/operands/mem0_addr.
	let value = (column19_row4 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_1 * column21_row8 + (1 - cpu_decode_opcode_range_check_bit_1) * column21_row0 + column0_row8)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/operands/mem1_addr.
	let value = (column19_row12 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_2 * column19_row0 + cpu_decode_opcode_range_check_bit_4 * column21_row0 + cpu_decode_opcode_range_check_bit_3 * column21_row8 + cpu_decode_flag_op1_base_op0_0 * column19_row5 + column0_row4)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((1 - cpu_decode_opcode_range_check_bit_9) * column21_row12 - (cpu_decode_opcode_range_check_bit_5 * (column19_row5 + column19_row13) + cpu_decode_opcode_range_check_bit_6 * column21_row4 + cpu_decode_flag_res_op1_0 * column19_row13)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_pc/tmp0.
	let value = (column21_row2 - cpu_decode_opcode_range_check_bit_9 * column19_row9) * domain18 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((1 - cpu_decode_opcode_range_check_bit_9) * column19_row16 + column21_row2 * (column19_row16 - (column19_row0 + column19_row13)) - (cpu_decode_flag_pc_update_regular_0 * npc_reg_0 + cpu_decode_opcode_range_check_bit_7 * column21_row12 + cpu_decode_opcode_range_check_bit_8 * (column19_row0 + column21_row12))) * domain18 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_pc/pc_cond_positive.
	let value = ((column21_row10 - cpu_decode_opcode_range_check_bit_9) * (column19_row16 - npc_reg_0)) * domain18 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_ap/ap_update.
	let value = (column21_row16 - (column21_row0 + cpu_decode_opcode_range_check_bit_10 * column21_row12 + cpu_decode_opcode_range_check_bit_11 + cpu_decode_opcode_range_check_bit_12 * 2)) * domain18 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_fp/fp_update.
	let value = (column21_row24 - (cpu_decode_fp_update_regular_0 * column21_row8 + cpu_decode_opcode_range_check_bit_13 * column19_row9 + cpu_decode_opcode_range_check_bit_12 * (column21_row0 + 2))) * domain18 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (cpu_decode_opcode_range_check_bit_12 * (column19_row5 - (column19_row0 + cpu_decode_opcode_range_check_bit_2 + 1))) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/call/off0.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column0_row0 - global_values.half_offset_size)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/call/off1.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column0_row8 - (global_values.half_offset_size + 1))) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (cpu_decode_opcode_range_check_bit_13 * (column0_row0 + 2 - global_values.half_offset_size)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/ret/off2.
	let value = (cpu_decode_opcode_range_check_bit_13 * (column0_row4 + 1 - global_values.half_offset_size)) / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((global_values.memory_multi_column_perm_perm_interaction_elm - (column20_row0 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column20_row1)) * column24_inter1_row0 + column19_row0 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column19_row1 - global_values.memory_multi_column_perm_perm_interaction_elm) / domain19;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: memory/multi_column_perm/perm/step0.
	let value = ((global_values.memory_multi_column_perm_perm_interaction_elm - (column20_row2 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column20_row3)) * column24_inter1_row2 - (global_values.memory_multi_column_perm_perm_interaction_elm - (column19_row2 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column19_row3)) * column24_inter1_row0) * domain20 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: memory/multi_column_perm/perm/last.
	let value = (column24_inter1_row0 - global_values.memory_multi_column_perm_perm_public_memory_prod) / domain20;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: memory/diff_is_bit.
	let value = (memory_address_diff_0 * memory_address_diff_0 - memory_address_diff_0) * domain20 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: memory/is_func.
	let value = ((memory_address_diff_0 - 1) * (column20_row1 - column20_row3)) * domain20 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((global_values.range_check16_perm_interaction_elm - column2_row0) * column23_inter1_row0 + column0_row0 - global_values.range_check16_perm_interaction_elm) / domain19;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/perm/step0.
	let value = ((global_values.range_check16_perm_interaction_elm - column2_row1) * column23_inter1_row1 - (global_values.range_check16_perm_interaction_elm - column0_row1) * column23_inter1_row0) * domain21 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/perm/last.
	let value = (column23_inter1_row0 - global_values.range_check16_perm_public_memory_prod) / domain21;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/diff_is_bit.
	let value = (range_check16_diff_0 * range_check16_diff_0 - range_check16_diff_0) * domain21 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column16_row255 * (column5_row1 - 3138550867693340381917894711603833208051177722232017256448 * column5_row192)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column16_row255 - column15_row255 * (column5_row192 - (column5_row193 + column5_row193))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column15_row255 - (column5_row251 - (column5_row252 + column5_row252)) * (column5_row196 - (column5_row197 + column5_row197))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column5_row251 - (column5_row252 + column5_row252)) * (column5_row197 - 18014398509481984 * column5_row251)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (pedersen_hash0_ec_subset_sum_bit_0 - 1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column4_row0 - global_values.pedersen_points_y) - column15_row0 * (column3_row0 - global_values.pedersen_points_x)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/x.
	let value = (column15_row0 * column15_row0 - pedersen_hash0_ec_subset_sum_bit_0 * (column3_row0 + global_values.pedersen_points_x + column3_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/y.
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column4_row0 + column4_row1) - column15_row0 * (column3_row0 - column3_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash0_ec_subset_sum_bit_neg_0 * (column3_row1 - column3_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash0_ec_subset_sum_bit_neg_0 * (column4_row1 - column4_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column18_row255 * (column8_row1 - 3138550867693340381917894711603833208051177722232017256448 * column8_row192)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column18_row255 - column17_row255 * (column8_row192 - (column8_row193 + column8_row193))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column17_row255 - (column8_row251 - (column8_row252 + column8_row252)) * (column8_row196 - (column8_row197 + column8_row197))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column8_row251 - (column8_row252 + column8_row252)) * (column8_row197 - 18014398509481984 * column8_row251)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (pedersen_hash1_ec_subset_sum_bit_0 - 1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (column7_row0 - global_values.pedersen_points_y) - column16_row0 * (column6_row0 - global_values.pedersen_points_x)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/add_points/x.
	let value = (column16_row0 * column16_row0 - pedersen_hash1_ec_subset_sum_bit_0 * (column6_row0 + global_values.pedersen_points_x + column6_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/add_points/y.
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (column7_row0 + column7_row1) - column16_row0 * (column6_row0 - column6_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash1_ec_subset_sum_bit_neg_0 * (column6_row1 - column6_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash1_ec_subset_sum_bit_neg_0 * (column7_row1 - column7_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column22_row144 * (column11_row1 - 3138550867693340381917894711603833208051177722232017256448 * column11_row192)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column22_row144 - column22_row16 * (column11_row192 - (column11_row193 + column11_row193))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column22_row16 - (column11_row251 - (column11_row252 + column11_row252)) * (column11_row196 - (column11_row197 + column11_row197))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column11_row251 - (column11_row252 + column11_row252)) * (column11_row197 - 18014398509481984 * column11_row251)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (pedersen_hash2_ec_subset_sum_bit_0 - 1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (column10_row0 - global_values.pedersen_points_y) - column17_row0 * (column9_row0 - global_values.pedersen_points_x)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/add_points/x.
	let value = (column17_row0 * column17_row0 - pedersen_hash2_ec_subset_sum_bit_0 * (column9_row0 + global_values.pedersen_points_x + column9_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/add_points/y.
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (column10_row0 + column10_row1) - column17_row0 * (column9_row0 - column9_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash2_ec_subset_sum_bit_neg_0 * (column9_row1 - column9_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash2_ec_subset_sum_bit_neg_0 * (column10_row1 - column10_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column22_row208 * (column14_row1 - 3138550867693340381917894711603833208051177722232017256448 * column14_row192)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column22_row208 - column22_row80 * (column14_row192 - (column14_row193 + column14_row193))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column22_row80 - (column14_row251 - (column14_row252 + column14_row252)) * (column14_row196 - (column14_row197 + column14_row197))) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column14_row251 - (column14_row252 + column14_row252)) * (column14_row197 - 18014398509481984 * column14_row251)) / domain7;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (pedersen_hash3_ec_subset_sum_bit_0 - 1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (column13_row0 - global_values.pedersen_points_y) - column18_row0 * (column12_row0 - global_values.pedersen_points_x)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/add_points/x.
	let value = (column18_row0 * column18_row0 - pedersen_hash3_ec_subset_sum_bit_0 * (column12_row0 + global_values.pedersen_points_x + column12_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/add_points/y.
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (column13_row0 + column13_row1) - column18_row0 * (column12_row0 - column12_row1)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash3_ec_subset_sum_bit_neg_0 * (column12_row1 - column12_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash3_ec_subset_sum_bit_neg_0 * (column13_row1 - column13_row0)) * domain8 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_doubling_key_x_squared + ecdsa_signature0_doubling_key_x_squared + ecdsa_signature0_doubling_key_x_squared + global_values.ecdsa_sig_config.alpha - (column21_row14 + column21_row14) * column21_row13) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/doubling_key/x.
	let value = (column21_row13 * column21_row13 - (column21_row6 + column21_row6 + column21_row22)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/doubling_key/y.
	let value = (column21_row14 + column21_row30 - column21_row13 * (column21_row6 - column21_row22)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/booleanity_test.
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (ecdsa_signature0_exponentiate_generator_bit_0 - 1)) * domain15 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (column21_row23 - global_values.ecdsa_generator_points_y) - column21_row31 * (column21_row7 - global_values.ecdsa_generator_points_x)) * domain15 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/x.
	let value = (column21_row31 * column21_row31 - ecdsa_signature0_exponentiate_generator_bit_0 * (column21_row7 + global_values.ecdsa_generator_points_x + column21_row39)) * domain15 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/y.
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (column21_row23 + column21_row55) - column21_row31 * (column21_row7 - column21_row39)) * domain15 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/x_diff_inv.
	let value = (column22_row0 * (column21_row7 - global_values.ecdsa_generator_points_x) - 1) * domain15 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/copy_point/x.
	let value = (ecdsa_signature0_exponentiate_generator_bit_neg_0 * (column21_row39 - column21_row7)) * domain15 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/copy_point/y.
	let value = (ecdsa_signature0_exponentiate_generator_bit_neg_0 * (column21_row55 - column21_row23)) * domain15 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/booleanity_test.
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (ecdsa_signature0_exponentiate_key_bit_0 - 1)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (column21_row9 - column21_row14) - column21_row3 * (column21_row1 - column21_row6)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/add_points/x.
	let value = (column21_row3 * column21_row3 - ecdsa_signature0_exponentiate_key_bit_0 * (column21_row1 + column21_row6 + column21_row17)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/add_points/y.
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (column21_row9 + column21_row25) - column21_row3 * (column21_row1 - column21_row17)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_exponentiate_key_bit_neg_0 * (column21_row17 - column21_row1)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/copy_point/y.
	let value = (ecdsa_signature0_exponentiate_key_bit_neg_0 * (column21_row25 - column21_row9)) * domain12 / domain4;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column21_row8183 - (column21_row4089 + column21_row8191 * (column21_row8167 - column21_row4081))) / domain17;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/add_results/x.
	let value = (column21_row8191 * column21_row8191 - (column21_row8167 + column21_row4081 + column21_row4102)) / domain17;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/add_results/y.
	let value = (column21_row8183 + column21_row4110 - column21_row8191 * (column21_row8167 - column21_row4102)) / domain17;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column21_row8185 + global_values.ecdsa_sig_config.shift_point.y - column21_row4083 * (column21_row8177 - global_values.ecdsa_sig_config.shift_point.x)) / domain17;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/extract_r/x.
	let value = (column21_row4083 * column21_row4083 - (column21_row8177 + global_values.ecdsa_sig_config.shift_point.x + column21_row5)) / domain17;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/extract_r/x_diff_inv.
	let value = (column21_row8179 * (column21_row8177 - global_values.ecdsa_sig_config.shift_point.x) - 1) / domain17;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column21_row14 * column21_row14 - (column21_row6 * column21_row8187 + global_values.ecdsa_sig_config.alpha * column21_row6 + global_values.ecdsa_sig_config.beta)) / domain17;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
...
fn eval_oods_polynomial_inner(
	...
	let column15 = *column_values.pop_front().unwrap();
	let column16 = *column_values.pop_front().unwrap();
	let column17 = *column_values.pop_front().unwrap();
	let column18 = *column_values.pop_front().unwrap();
	let column19 = *column_values.pop_front().unwrap();
	let column20 = *column_values.pop_front().unwrap();
	let column21 = *column_values.pop_front().unwrap();
	let column22 = *column_values.pop_front().unwrap();
	let column23 = *column_values.pop_front().unwrap();
	let column24 = *column_values.pop_front().unwrap();
	...
	assert(203 == MASK_SIZE + CONSTRAINT_DEGREE, 'Assert failed');
	return total_sum;
}
