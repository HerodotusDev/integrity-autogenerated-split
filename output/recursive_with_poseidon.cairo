fn eval_composition_polynomial_inner(
	...
	let memory__address_diff_0 = column2_row2 - column2_row0;
	let range_check16__diff_0 = column4_row6 - column4_row2;
	let pedersen__hash0__ec_subset_sum__bit_0 = column4_row3 - (column4_row11 + column4_row11);
	let pedersen__hash0__ec_subset_sum__bit_neg_0 = 1 - pedersen_hash0_ec_subset_sum_bit_0;
	let range_check_builtin__value0_0 = column4_row12;
	let range_check_builtin__value1_0 = range_check_builtin_value0_0 * global_values.offset_size + column4_row44;
	let range_check_builtin__value2_0 = range_check_builtin_value1_0 * global_values.offset_size + column4_row76;
	let range_check_builtin__value3_0 = range_check_builtin_value2_0 * global_values.offset_size + column4_row108;
	let range_check_builtin__value4_0 = range_check_builtin_value3_0 * global_values.offset_size + column4_row140;
	let range_check_builtin__value5_0 = range_check_builtin_value4_0 * global_values.offset_size + column4_row172;
	let range_check_builtin__value6_0 = range_check_builtin_value5_0 * global_values.offset_size + column4_row204;
	let range_check_builtin__value7_0 = range_check_builtin_value6_0 * global_values.offset_size + column4_row236;
	let bitwise__sum_var_0_0 = column3_row0 + column3_row4 * 2 + column3_row8 * 4 + column3_row12 * 8 + column3_row16 * 18446744073709551616 + column3_row20 * 36893488147419103232 + column3_row24 * 73786976294838206464 + column3_row28 * 147573952589676412928;
	let bitwise__sum_var_8_0 = column3_row32 * 340282366920938463463374607431768211456 + column3_row36 * 680564733841876926926749214863536422912 + column3_row40 * 1361129467683753853853498429727072845824 + column3_row44 * 2722258935367507707706996859454145691648 + column3_row48 * 6277101735386680763835789423207666416102355444464034512896 + column3_row52 * 12554203470773361527671578846415332832204710888928069025792 + column3_row56 * 25108406941546723055343157692830665664409421777856138051584 + column3_row60 * 50216813883093446110686315385661331328818843555712276103168;
	let poseidon__poseidon__full_rounds_state0_cubed_0 = column5_row9 * column5_row105;
	let poseidon__poseidon__full_rounds_state1_cubed_0 = column5_row73 * column5_row25;
	let poseidon__poseidon__full_rounds_state2_cubed_0 = column5_row41 * column5_row89;
	let poseidon__poseidon__full_rounds_state0_cubed_7 = column5_row905 * column5_row1001;
	let poseidon__poseidon__full_rounds_state1_cubed_7 = column5_row969 * column5_row921;
	let poseidon__poseidon__full_rounds_state2_cubed_7 = column5_row937 * column5_row985;
	let poseidon__poseidon__full_rounds_state0_cubed_3 = column5_row393 * column5_row489;
	let poseidon__poseidon__full_rounds_state1_cubed_3 = column5_row457 * column5_row409;
	let poseidon__poseidon__full_rounds_state2_cubed_3 = column5_row425 * column5_row473;
	let poseidon__poseidon__partial_rounds_state0_cubed_0 = column5_row6 * column5_row14;
	let poseidon__poseidon__partial_rounds_state0_cubed_1 = column5_row22 * column5_row30;
	let poseidon__poseidon__partial_rounds_state0_cubed_2 = column5_row38 * column5_row46;
	let poseidon__poseidon__partial_rounds_state1_cubed_0 = column5_row1 * column5_row17;
	let poseidon__poseidon__partial_rounds_state1_cubed_1 = column5_row33 * column5_row49;
	let poseidon__poseidon__partial_rounds_state1_cubed_2 = column5_row65 * column5_row81;
	let poseidon__poseidon__partial_rounds_state1_cubed_19 = column5_row609 * column5_row625;
	let poseidon__poseidon__partial_rounds_state1_cubed_20 = column5_row641 * column5_row657;
	let poseidon__poseidon__partial_rounds_state1_cubed_21 = column5_row673 * column5_row689;
	...
	let value = (column1_row1 - (((column0_row0 * global_values.offset_size + column4_row4) * global_values.offset_size + column4_row8) * global_values.offset_size + column4_row0)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column1_row8 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_0 * column5_row8 + (1 - cpu_decode_opcode_range_check_bit_0) * column5_row0 + column4_row0)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/operands/mem0_addr.
	let value = (column1_row4 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_1 * column5_row8 + (1 - cpu_decode_opcode_range_check_bit_1) * column5_row0 + column4_row8)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/operands/mem1_addr.
	let value = (column1_row12 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_2 * column1_row0 + cpu_decode_opcode_range_check_bit_4 * column5_row0 + cpu_decode_opcode_range_check_bit_3 * column5_row8 + cpu_decode_flag_op1_base_op0_0 * column1_row5 + column4_row4)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((1 - cpu_decode_opcode_range_check_bit_9) * column5_row12 - (cpu_decode_opcode_range_check_bit_5 * (column1_row5 + column1_row13) + cpu_decode_opcode_range_check_bit_6 * column5_row4 + cpu_decode_flag_res_op1_0 * column1_row13)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_pc/tmp0.
	let value = (column5_row2 - cpu_decode_opcode_range_check_bit_9 * column1_row9) * domain24 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((1 - cpu_decode_opcode_range_check_bit_9) * column1_row16 + column5_row2 * (column1_row16 - (column1_row0 + column1_row13)) - (cpu_decode_flag_pc_update_regular_0 * npc_reg_0 + cpu_decode_opcode_range_check_bit_7 * column5_row12 + cpu_decode_opcode_range_check_bit_8 * (column1_row0 + column5_row12))) * domain24 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_pc/pc_cond_positive.
	let value = ((column5_row10 - cpu_decode_opcode_range_check_bit_9) * (column1_row16 - npc_reg_0)) * domain24 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_ap/ap_update.
	let value = (column5_row16 - (column5_row0 + cpu_decode_opcode_range_check_bit_10 * column5_row12 + cpu_decode_opcode_range_check_bit_11 + cpu_decode_opcode_range_check_bit_12 * 2)) * domain24 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_fp/fp_update.
	let value = (column5_row24 - (cpu_decode_fp_update_regular_0 * column5_row8 + cpu_decode_opcode_range_check_bit_13 * column1_row9 + cpu_decode_opcode_range_check_bit_12 * (column5_row0 + 2))) * domain24 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (cpu_decode_opcode_range_check_bit_12 * (column1_row5 - (column1_row0 + cpu_decode_opcode_range_check_bit_2 + 1))) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/call/off0.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column4_row0 - global_values.half_offset_size)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/call/off1.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column4_row8 - (global_values.half_offset_size + 1))) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (cpu_decode_opcode_range_check_bit_13 * (column4_row0 + 2 - global_values.half_offset_size)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/ret/off2.
	let value = (cpu_decode_opcode_range_check_bit_13 * (column4_row4 + 1 - global_values.half_offset_size)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((global_values.memory_multi_column_perm_perm_interaction_elm - (column2_row0 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column2_row1)) * column6_inter1_row0 + column1_row0 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column1_row1 - global_values.memory_multi_column_perm_perm_interaction_elm) / domain25;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column6_inter1_row0 - global_values.memory_multi_column_perm_perm_public_memory_prod) / domain26;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: memory/diff_is_bit.
	let value = (memory_address_diff_0 * memory_address_diff_0 - memory_address_diff_0) * domain26 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((global_values.range_check16_perm_interaction_elm - column4_row2) * column7_inter1_row1 + column4_row0 - global_values.range_check16_perm_interaction_elm) / domain25;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/perm/step0.
	let value = ((global_values.range_check16_perm_interaction_elm - column4_row6) * column7_inter1_row5 - (global_values.range_check16_perm_interaction_elm - column4_row4) * column7_inter1_row1) * domain27 / domain2;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/perm/last.
	let value = (column7_inter1_row1 - global_values.range_check16_perm_public_memory_prod) / domain27;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/diff_is_bit.
	let value = (range_check16_diff_0 * range_check16_diff_0 - range_check16_diff_0) * domain27 / domain2;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((global_values.diluted_check_permutation_interaction_elm - column3_row1) * column7_inter1_row0 + column3_row0 - global_values.diluted_check_permutation_interaction_elm) / domain25;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: diluted_check/permutation/step0.
	let value = ((global_values.diluted_check_permutation_interaction_elm - column3_row3) * column7_inter1_row2 - (global_values.diluted_check_permutation_interaction_elm - column3_row2) * column7_inter1_row0) * domain26 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: diluted_check/permutation/last.
	let value = (column7_inter1_row0 - global_values.diluted_check_permutation_public_memory_prod) / domain26;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column6_inter1_row3 - (column6_inter1_row1 * (1 + global_values.diluted_check_interaction_z * (column3_row3 - column3_row1)) + global_values.diluted_check_interaction_alpha * (column3_row3 - column3_row1) * (column3_row3 - column3_row1))) * domain26 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column5_row57 * (column4_row11 - 3138550867693340381917894711603833208051177722232017256448 * column4_row1539)) / domain19;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column5_row57 - column4_row2047 * (column4_row1539 - (column4_row1547 + column4_row1547))) / domain19;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column4_row2047 - (column4_row2011 - (column4_row2019 + column4_row2019)) * (column4_row1571 - (column4_row1579 + column4_row1579))) / domain19;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column4_row2011 - (column4_row2019 + column4_row2019)) * (column4_row1579 - 18014398509481984 * column4_row2011)) / domain19;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (pedersen_hash0_ec_subset_sum_bit_0 - 1)) * domain20 / domain3;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column4_row5 - global_values.pedersen_points_y) - column4_row7 * (column4_row1 - global_values.pedersen_points_x)) * domain20 / domain3;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/x.
	let value = (column4_row7 * column4_row7 - pedersen_hash0_ec_subset_sum_bit_0 * (column4_row1 + global_values.pedersen_points_x + column4_row9)) * domain20 / domain3;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/y.
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column4_row5 + column4_row13) - column4_row7 * (column4_row1 - column4_row9)) * domain20 / domain3;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash0_ec_subset_sum_bit_neg_0 * (column4_row9 - column4_row1)) * domain20 / domain3;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash0_ec_subset_sum_bit_neg_0 * (column4_row13 - column4_row5)) * domain20 / domain3;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column3_row0 + column3_row64 - (column3_row192 + column3_row128 + column3_row128)) / domain11;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column1_row267 + 2950795762459345168613727575620414179244544320470208355568817838579231751791 - column5_row9) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/add_first_round_key1.
	let value = (column1_row203 + 1587446564224215276866294500450702039420286416111469274423465069420553242820 - column5_row73) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/add_first_round_key2.
	let value = (column1_row459 + 1645965921169490687904413452218868659025437693527479459426157555728339600137 - column5_row41) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/full_round0.
	let value = (column5_row137 - (poseidon_poseidon_full_rounds_state0_cubed_0 + poseidon_poseidon_full_rounds_state0_cubed_0 + poseidon_poseidon_full_rounds_state0_cubed_0 + poseidon_poseidon_full_rounds_state1_cubed_0 + poseidon_poseidon_full_rounds_state2_cubed_0 + global_values.poseidon_poseidon_full_round_key0)) * domain13 / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/full_round1.
	let value = (column5_row201 + poseidon_poseidon_full_rounds_state1_cubed_0 - (poseidon_poseidon_full_rounds_state0_cubed_0 + poseidon_poseidon_full_rounds_state2_cubed_0 + global_values.poseidon_poseidon_full_round_key1)) * domain13 / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/full_round2.
	let value = (column5_row169 + poseidon_poseidon_full_rounds_state2_cubed_0 + poseidon_poseidon_full_rounds_state2_cubed_0 - (poseidon_poseidon_full_rounds_state0_cubed_0 + poseidon_poseidon_full_rounds_state1_cubed_0 + global_values.poseidon_poseidon_full_round_key2)) * domain13 / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/last_full_round0.
	let value = (column1_row779 - (poseidon_poseidon_full_rounds_state0_cubed_7 + poseidon_poseidon_full_rounds_state0_cubed_7 + poseidon_poseidon_full_rounds_state0_cubed_7 + poseidon_poseidon_full_rounds_state1_cubed_7 + poseidon_poseidon_full_rounds_state2_cubed_7)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/last_full_round1.
	let value = (column1_row715 + poseidon_poseidon_full_rounds_state1_cubed_7 - (poseidon_poseidon_full_rounds_state0_cubed_7 + poseidon_poseidon_full_rounds_state2_cubed_7)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/last_full_round2.
	let value = (column1_row971 + poseidon_poseidon_full_rounds_state2_cubed_7 + poseidon_poseidon_full_rounds_state2_cubed_7 - (poseidon_poseidon_full_rounds_state0_cubed_7 + poseidon_poseidon_full_rounds_state1_cubed_7)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column5_row6 + poseidon_poseidon_full_rounds_state2_cubed_3 + poseidon_poseidon_full_rounds_state2_cubed_3 - (poseidon_poseidon_full_rounds_state0_cubed_3 + poseidon_poseidon_full_rounds_state1_cubed_3 + 2121140748740143694053732746913428481442990369183417228688865837805149503386)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/margin_full_to_partial1.
	let value = (column5_row22 - (3618502788666131213697322783095070105623107215331596699973092056135872020477 * poseidon_poseidon_full_rounds_state1_cubed_3 + 10 * poseidon_poseidon_full_rounds_state2_cubed_3 + 4 * column5_row6 + 3618502788666131213697322783095070105623107215331596699973092056135872020479 * poseidon_poseidon_partial_rounds_state0_cubed_0 + 2006642341318481906727563724340978325665491359415674592697055778067937914672)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/margin_full_to_partial2.
	let value = (column5_row38 - (8 * poseidon_poseidon_full_rounds_state2_cubed_3 + 4 * column5_row6 + 6 * poseidon_poseidon_partial_rounds_state0_cubed_0 + column5_row22 + column5_row22 + 3618502788666131213697322783095070105623107215331596699973092056135872020479 * poseidon_poseidon_partial_rounds_state0_cubed_1 + 427751140904099001132521606468025610873158555767197326325930641757709538586)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/partial_round0.
	let value = (column5_row54 - (8 * poseidon_poseidon_partial_rounds_state0_cubed_0 + 4 * column5_row22 + 6 * poseidon_poseidon_partial_rounds_state0_cubed_1 + column5_row38 + column5_row38 + 3618502788666131213697322783095070105623107215331596699973092056135872020479 * poseidon_poseidon_partial_rounds_state0_cubed_2 + global_values.poseidon_poseidon_partial_round_key0)) * domain17 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/partial_round1.
	let value = (column5_row97 - (8 * poseidon_poseidon_partial_rounds_state1_cubed_0 + 4 * column5_row33 + 6 * poseidon_poseidon_partial_rounds_state1_cubed_1 + column5_row65 + column5_row65 + 3618502788666131213697322783095070105623107215331596699973092056135872020479 * poseidon_poseidon_partial_rounds_state1_cubed_2 + global_values.poseidon_poseidon_partial_round_key1)) * domain18 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/margin_partial_to_full0.
	let value = (column5_row521 - (16 * poseidon_poseidon_partial_rounds_state1_cubed_19 + 8 * column5_row641 + 16 * poseidon_poseidon_partial_rounds_state1_cubed_20 + 6 * column5_row673 + poseidon_poseidon_partial_rounds_state1_cubed_21 + 560279373700919169769089400651532183647886248799764942664266404650165812023)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/margin_partial_to_full1.
	let value = (column5_row585 - (4 * poseidon_poseidon_partial_rounds_state1_cubed_20 + column5_row673 + column5_row673 + poseidon_poseidon_partial_rounds_state1_cubed_21 + 1401754474293352309994371631695783042590401941592571735921592823982231996415)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: poseidon/poseidon/margin_partial_to_full2.
	let value = (column5_row553 - (8 * poseidon_poseidon_partial_rounds_state1_cubed_19 + 4 * column5_row641 + 6 * poseidon_poseidon_partial_rounds_state1_cubed_20 + column5_row673 + column5_row673 + 3618502788666131213697322783095070105623107215331596699973092056135872020479 * poseidon_poseidon_partial_rounds_state1_cubed_21 + 1246177936547655338400308396717835700699368047388302793172818304164989556526)) / domain16;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
...
fn eval_oods_polynomial_inner(
	...
	assert(194 == MASK_SIZE + CONSTRAINT_DEGREE, 'Assert failed');
	return total_sum;
}
