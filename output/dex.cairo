fn eval_composition_polynomial_inner(
	...
	let column4_row511 = *mask_values.pop_front().unwrap();
	let column5_row0 = *mask_values.pop_front().unwrap();
	let column5_row1 = *mask_values.pop_front().unwrap();
	let column5_row255 = *mask_values.pop_front().unwrap();
	...
	let column6_row192 = *mask_values.pop_front().unwrap();
	let column6_row193 = *mask_values.pop_front().unwrap();
	let column6_row196 = *mask_values.pop_front().unwrap();
	let column6_row197 = *mask_values.pop_front().unwrap();
	let column6_row251 = *mask_values.pop_front().unwrap();
	let column6_row252 = *mask_values.pop_front().unwrap();
	...
	let column7_row511 = *mask_values.pop_front().unwrap();
	let column8_row0 = *mask_values.pop_front().unwrap();
	let column8_row1 = *mask_values.pop_front().unwrap();
	let column8_row255 = *mask_values.pop_front().unwrap();
	...
	let column9_row192 = *mask_values.pop_front().unwrap();
	let column9_row193 = *mask_values.pop_front().unwrap();
	let column9_row196 = *mask_values.pop_front().unwrap();
	let column9_row197 = *mask_values.pop_front().unwrap();
	let column9_row251 = *mask_values.pop_front().unwrap();
	let column9_row252 = *mask_values.pop_front().unwrap();
	...
	let column10_row511 = *mask_values.pop_front().unwrap();
	let column11_row0 = *mask_values.pop_front().unwrap();
	let column11_row1 = *mask_values.pop_front().unwrap();
	let column11_row255 = *mask_values.pop_front().unwrap();
	...
	let column12_row192 = *mask_values.pop_front().unwrap();
	let column12_row193 = *mask_values.pop_front().unwrap();
	let column12_row196 = *mask_values.pop_front().unwrap();
	let column12_row197 = *mask_values.pop_front().unwrap();
	let column12_row251 = *mask_values.pop_front().unwrap();
	let column12_row252 = *mask_values.pop_front().unwrap();
	...
	let column14_row255 = *mask_values.pop_front().unwrap();
	...
	let column17_row1 = *mask_values.pop_front().unwrap();
	let column17_row2 = *mask_values.pop_front().unwrap();
	let column17_row3 = *mask_values.pop_front().unwrap();
	let column17_row4 = *mask_values.pop_front().unwrap();
	let column17_row5 = *mask_values.pop_front().unwrap();
	let column17_row6 = *mask_values.pop_front().unwrap();
	let column17_row7 = *mask_values.pop_front().unwrap();
	let column17_row8 = *mask_values.pop_front().unwrap();
	let column17_row9 = *mask_values.pop_front().unwrap();
	let column17_row12 = *mask_values.pop_front().unwrap();
	let column17_row13 = *mask_values.pop_front().unwrap();
	let column17_row16 = *mask_values.pop_front().unwrap();
	let column17_row22 = *mask_values.pop_front().unwrap();
	let column17_row23 = *mask_values.pop_front().unwrap();
	let column17_row38 = *mask_values.pop_front().unwrap();
	let column17_row39 = *mask_values.pop_front().unwrap();
	let column17_row70 = *mask_values.pop_front().unwrap();
	let column17_row71 = *mask_values.pop_front().unwrap();
	let column17_row102 = *mask_values.pop_front().unwrap();
	let column17_row103 = *mask_values.pop_front().unwrap();
	let column17_row134 = *mask_values.pop_front().unwrap();
	let column17_row135 = *mask_values.pop_front().unwrap();
	let column17_row167 = *mask_values.pop_front().unwrap();
	let column17_row199 = *mask_values.pop_front().unwrap();
	let column17_row230 = *mask_values.pop_front().unwrap();
	let column17_row263 = *mask_values.pop_front().unwrap();
	let column17_row295 = *mask_values.pop_front().unwrap();
	let column17_row327 = *mask_values.pop_front().unwrap();
	let column17_row391 = *mask_values.pop_front().unwrap();
	let column17_row423 = *mask_values.pop_front().unwrap();
	let column17_row455 = *mask_values.pop_front().unwrap();
	let column17_row4118 = *mask_values.pop_front().unwrap();
	let column17_row4119 = *mask_values.pop_front().unwrap();
	let column17_row8214 = *mask_values.pop_front().unwrap();
	let column18_row0 = *mask_values.pop_front().unwrap();
	let column18_row1 = *mask_values.pop_front().unwrap();
	let column18_row2 = *mask_values.pop_front().unwrap();
	let column18_row3 = *mask_values.pop_front().unwrap();
	...
	let column19_row11 = *mask_values.pop_front().unwrap();
	let column19_row12 = *mask_values.pop_front().unwrap();
	let column19_row13 = *mask_values.pop_front().unwrap();
	let column19_row15 = *mask_values.pop_front().unwrap();
	let column19_row17 = *mask_values.pop_front().unwrap();
	let column19_row23 = *mask_values.pop_front().unwrap();
	let column19_row25 = *mask_values.pop_front().unwrap();
	let column19_row28 = *mask_values.pop_front().unwrap();
	let column19_row31 = *mask_values.pop_front().unwrap();
	let column19_row44 = *mask_values.pop_front().unwrap();
	let column19_row60 = *mask_values.pop_front().unwrap();
	let column19_row76 = *mask_values.pop_front().unwrap();
	let column19_row92 = *mask_values.pop_front().unwrap();
	let column19_row108 = *mask_values.pop_front().unwrap();
	let column19_row124 = *mask_values.pop_front().unwrap();
	let column19_row4103 = *mask_values.pop_front().unwrap();
	let column19_row4111 = *mask_values.pop_front().unwrap();
	...
	let column20_row4 = *mask_values.pop_front().unwrap();
	let column20_row6 = *mask_values.pop_front().unwrap();
	let column20_row8 = *mask_values.pop_front().unwrap();
	let column20_row10 = *mask_values.pop_front().unwrap();
	let column20_row12 = *mask_values.pop_front().unwrap();
	let column20_row14 = *mask_values.pop_front().unwrap();
	let column20_row16 = *mask_values.pop_front().unwrap();
	let column20_row17 = *mask_values.pop_front().unwrap();
	let column20_row20 = *mask_values.pop_front().unwrap();
	let column20_row22 = *mask_values.pop_front().unwrap();
	let column20_row24 = *mask_values.pop_front().unwrap();
	let column20_row30 = *mask_values.pop_front().unwrap();
	let column20_row38 = *mask_values.pop_front().unwrap();
	let column20_row46 = *mask_values.pop_front().unwrap();
	let column20_row54 = *mask_values.pop_front().unwrap();
	let column20_row81 = *mask_values.pop_front().unwrap();
	let column20_row145 = *mask_values.pop_front().unwrap();
	let column20_row209 = *mask_values.pop_front().unwrap();
	let column20_row4080 = *mask_values.pop_front().unwrap();
	let column20_row4082 = *mask_values.pop_front().unwrap();
	let column20_row4088 = *mask_values.pop_front().unwrap();
	let column20_row4090 = *mask_values.pop_front().unwrap();
	let column20_row4092 = *mask_values.pop_front().unwrap();
	let column20_row8161 = *mask_values.pop_front().unwrap();
	let column20_row8166 = *mask_values.pop_front().unwrap();
	let column20_row8176 = *mask_values.pop_front().unwrap();
	let column20_row8178 = *mask_values.pop_front().unwrap();
	let column20_row8182 = *mask_values.pop_front().unwrap();
	let column20_row8184 = *mask_values.pop_front().unwrap();
	let column20_row8186 = *mask_values.pop_front().unwrap();
	let column20_row8190 = *mask_values.pop_front().unwrap();
	let column21_inter1_row0 = *mask_values.pop_front().unwrap();
	let column21_inter1_row1 = *mask_values.pop_front().unwrap();
	let column21_inter1_row2 = *mask_values.pop_front().unwrap();
	let column21_inter1_row5 = *mask_values.pop_front().unwrap();
	...
	let memory__address_diff_0 = column18_row2 - column18_row0;
	let range_check16__diff_0 = column19_row6 - column19_row2;
	...
	let pedersen__hash1__ec_subset_sum__bit_0 = column6_row0 - (column6_row1 + column6_row1);
	let pedersen__hash1__ec_subset_sum__bit_neg_0 = 1 - pedersen_hash1_ec_subset_sum_bit_0;
	let pedersen__hash2__ec_subset_sum__bit_0 = column9_row0 - (column9_row1 + column9_row1);
	let pedersen__hash2__ec_subset_sum__bit_neg_0 = 1 - pedersen_hash2_ec_subset_sum_bit_0;
	let pedersen__hash3__ec_subset_sum__bit_0 = column12_row0 - (column12_row1 + column12_row1);
	let pedersen__hash3__ec_subset_sum__bit_neg_0 = 1 - pedersen_hash3_ec_subset_sum_bit_0;
	let range_check_builtin__value0_0 = column19_row12;
	let range_check_builtin__value1_0 = range_check_builtin_value0_0 * global_values.offset_size + column19_row28;
	let range_check_builtin__value2_0 = range_check_builtin_value1_0 * global_values.offset_size + column19_row44;
	let range_check_builtin__value3_0 = range_check_builtin_value2_0 * global_values.offset_size + column19_row60;
	let range_check_builtin__value4_0 = range_check_builtin_value3_0 * global_values.offset_size + column19_row76;
	let range_check_builtin__value5_0 = range_check_builtin_value4_0 * global_values.offset_size + column19_row92;
	let range_check_builtin__value6_0 = range_check_builtin_value5_0 * global_values.offset_size + column19_row108;
	let range_check_builtin__value7_0 = range_check_builtin_value6_0 * global_values.offset_size + column19_row124;
	let ecdsa__signature0__doubling_key__x_squared = column19_row7 * column19_row7;
	let ecdsa__signature0__exponentiate_generator__bit_0 = column20_row14 - (column20_row46 + column20_row46);
	let ecdsa__signature0__exponentiate_generator__bit_neg_0 = 1 - ecdsa_signature0_exponentiate_generator_bit_0;
	let ecdsa__signature0__exponentiate_key__bit_0 = column20_row4 - (column20_row20 + column20_row20);
	...
	let value = (column17_row1 - (((column0_row0 * global_values.offset_size + column19_row4) * global_values.offset_size + column19_row8) * global_values.offset_size + column19_row0)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column17_row8 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_0 * column19_row9 + (1 - cpu_decode_opcode_range_check_bit_0) * column19_row1 + column19_row0)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/operands/mem0_addr.
	let value = (column17_row4 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_1 * column19_row9 + (1 - cpu_decode_opcode_range_check_bit_1) * column19_row1 + column19_row8)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/operands/mem1_addr.
	let value = (column17_row12 + global_values.half_offset_size - (cpu_decode_opcode_range_check_bit_2 * column17_row0 + cpu_decode_opcode_range_check_bit_4 * column19_row1 + cpu_decode_opcode_range_check_bit_3 * column19_row9 + cpu_decode_flag_op1_base_op0_0 * column17_row5 + column19_row4)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((1 - cpu_decode_opcode_range_check_bit_9) * column19_row13 - (cpu_decode_opcode_range_check_bit_5 * (column17_row5 + column17_row13) + cpu_decode_opcode_range_check_bit_6 * column19_row5 + cpu_decode_flag_res_op1_0 * column17_row13)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_pc/tmp0.
	let value = (column19_row3 - cpu_decode_opcode_range_check_bit_9 * column17_row9) * domain19 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((1 - cpu_decode_opcode_range_check_bit_9) * column17_row16 + column19_row3 * (column17_row16 - (column17_row0 + column17_row13)) - (cpu_decode_flag_pc_update_regular_0 * npc_reg_0 + cpu_decode_opcode_range_check_bit_7 * column19_row13 + cpu_decode_opcode_range_check_bit_8 * (column17_row0 + column19_row13))) * domain19 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_pc/pc_cond_positive.
	let value = ((column19_row11 - cpu_decode_opcode_range_check_bit_9) * (column17_row16 - npc_reg_0)) * domain19 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_ap/ap_update.
	let value = (column19_row17 - (column19_row1 + cpu_decode_opcode_range_check_bit_10 * column19_row13 + cpu_decode_opcode_range_check_bit_11 + cpu_decode_opcode_range_check_bit_12 * 2)) * domain19 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/update_registers/update_fp/fp_update.
	let value = (column19_row25 - (cpu_decode_fp_update_regular_0 * column19_row9 + cpu_decode_opcode_range_check_bit_13 * column17_row9 + cpu_decode_opcode_range_check_bit_12 * (column19_row1 + 2))) * domain19 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (cpu_decode_opcode_range_check_bit_12 * (column17_row5 - (column17_row0 + cpu_decode_opcode_range_check_bit_2 + 1))) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/call/off0.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column19_row0 - global_values.half_offset_size)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/call/off1.
	let value = (cpu_decode_opcode_range_check_bit_12 * (column19_row8 - (global_values.half_offset_size + 1))) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (cpu_decode_opcode_range_check_bit_13 * (column19_row0 + 2 - global_values.half_offset_size)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: cpu/opcodes/ret/off2.
	let value = (cpu_decode_opcode_range_check_bit_13 * (column19_row4 + 1 - global_values.half_offset_size)) / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((global_values.memory_multi_column_perm_perm_interaction_elm - (column18_row0 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column18_row1)) * column21_inter1_row0 + column17_row0 + global_values.memory_multi_column_perm_hash_interaction_elm0 * column17_row1 - global_values.memory_multi_column_perm_perm_interaction_elm) / domain20;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column21_inter1_row0 - global_values.memory_multi_column_perm_perm_public_memory_prod) / domain21;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: memory/diff_is_bit.
	let value = (memory_address_diff_0 * memory_address_diff_0 - memory_address_diff_0) * domain21 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: memory/is_func.
	let value = ((memory_address_diff_0 - 1) * (column18_row1 - column18_row3)) * domain21 / domain1;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = ((global_values.range_check16_perm_interaction_elm - column19_row2) * column21_inter1_row1 + column19_row0 - global_values.range_check16_perm_interaction_elm) / domain20;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/perm/step0.
	let value = ((global_values.range_check16_perm_interaction_elm - column19_row6) * column21_inter1_row5 - (global_values.range_check16_perm_interaction_elm - column19_row4) * column21_inter1_row1) * domain22 / domain2;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/perm/last.
	let value = (column21_inter1_row1 - global_values.range_check16_perm_public_memory_prod) / domain22;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: range_check16/diff_is_bit.
	let value = (range_check16_diff_0 * range_check16_diff_0 - range_check16_diff_0) * domain22 / domain2;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column14_row255 * (column3_row1 - 3138550867693340381917894711603833208051177722232017256448 * column3_row192)) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column14_row255 - column13_row255 * (column3_row192 - (column3_row193 + column3_row193))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column13_row255 - (column3_row251 - (column3_row252 + column3_row252)) * (column3_row196 - (column3_row197 + column3_row197))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column2_row0 - global_values.pedersen_points_y) - column13_row0 * (column1_row0 - global_values.pedersen_points_x)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/x.
	let value = (column13_row0 * column13_row0 - pedersen_hash0_ec_subset_sum_bit_0 * (column1_row0 + global_values.pedersen_points_x + column1_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash0/ec_subset_sum/add_points/y.
	let value = (pedersen_hash0_ec_subset_sum_bit_0 * (column2_row0 + column2_row1) - column13_row0 * (column1_row0 - column1_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column16_row255 * (column6_row1 - 3138550867693340381917894711603833208051177722232017256448 * column6_row192)) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column16_row255 - column15_row255 * (column6_row192 - (column6_row193 + column6_row193))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column15_row255 - (column6_row251 - (column6_row252 + column6_row252)) * (column6_row196 - (column6_row197 + column6_row197))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column6_row251 - (column6_row252 + column6_row252)) * (column6_row197 - 18014398509481984 * column6_row251)) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (pedersen_hash1_ec_subset_sum_bit_0 - 1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (column5_row0 - global_values.pedersen_points_y) - column14_row0 * (column4_row0 - global_values.pedersen_points_x)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/add_points/x.
	let value = (column14_row0 * column14_row0 - pedersen_hash1_ec_subset_sum_bit_0 * (column4_row0 + global_values.pedersen_points_x + column4_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/add_points/y.
	let value = (pedersen_hash1_ec_subset_sum_bit_0 * (column5_row0 + column5_row1) - column14_row0 * (column4_row0 - column4_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash1_ec_subset_sum_bit_neg_0 * (column4_row1 - column4_row0)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash1/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash1_ec_subset_sum_bit_neg_0 * (column5_row1 - column5_row0)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column20_row145 * (column9_row1 - 3138550867693340381917894711603833208051177722232017256448 * column9_row192)) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column20_row145 - column20_row17 * (column9_row192 - (column9_row193 + column9_row193))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column20_row17 - (column9_row251 - (column9_row252 + column9_row252)) * (column9_row196 - (column9_row197 + column9_row197))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column9_row251 - (column9_row252 + column9_row252)) * (column9_row197 - 18014398509481984 * column9_row251)) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (pedersen_hash2_ec_subset_sum_bit_0 - 1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (column8_row0 - global_values.pedersen_points_y) - column15_row0 * (column7_row0 - global_values.pedersen_points_x)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/add_points/x.
	let value = (column15_row0 * column15_row0 - pedersen_hash2_ec_subset_sum_bit_0 * (column7_row0 + global_values.pedersen_points_x + column7_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/add_points/y.
	let value = (pedersen_hash2_ec_subset_sum_bit_0 * (column8_row0 + column8_row1) - column15_row0 * (column7_row0 - column7_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash2_ec_subset_sum_bit_neg_0 * (column7_row1 - column7_row0)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash2/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash2_ec_subset_sum_bit_neg_0 * (column8_row1 - column8_row0)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column20_row209 * (column12_row1 - 3138550867693340381917894711603833208051177722232017256448 * column12_row192)) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/bit_unpacking/cumulative_bit192.
	let value = (column20_row209 - column20_row81 * (column12_row192 - (column12_row193 + column12_row193))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column20_row81 - (column12_row251 - (column12_row252 + column12_row252)) * (column12_row196 - (column12_row197 + column12_row197))) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/bit_unpacking/zeroes_between_ones196.
	let value = ((column12_row251 - (column12_row252 + column12_row252)) * (column12_row197 - 18014398509481984 * column12_row251)) / domain8;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/booleanity_test.
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (pedersen_hash3_ec_subset_sum_bit_0 - 1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (column11_row0 - global_values.pedersen_points_y) - column16_row0 * (column10_row0 - global_values.pedersen_points_x)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/add_points/x.
	let value = (column16_row0 * column16_row0 - pedersen_hash3_ec_subset_sum_bit_0 * (column10_row0 + global_values.pedersen_points_x + column10_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/add_points/y.
	let value = (pedersen_hash3_ec_subset_sum_bit_0 * (column11_row0 + column11_row1) - column16_row0 * (column10_row0 - column10_row1)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/copy_point/x.
	let value = (pedersen_hash3_ec_subset_sum_bit_neg_0 * (column10_row1 - column10_row0)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: pedersen/hash3/ec_subset_sum/copy_point/y.
	let value = (pedersen_hash3_ec_subset_sum_bit_neg_0 * (column11_row1 - column11_row0)) * domain9 / domain0;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_doubling_key_x_squared + ecdsa_signature0_doubling_key_x_squared + ecdsa_signature0_doubling_key_x_squared + global_values.ecdsa_sig_config.alpha - (column19_row15 + column19_row15) * column20_row12) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/doubling_key/x.
	let value = (column20_row12 * column20_row12 - (column19_row7 + column19_row7 + column19_row23)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/doubling_key/y.
	let value = (column19_row15 + column19_row31 - column20_row12 * (column19_row7 - column19_row23)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/booleanity_test.
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (ecdsa_signature0_exponentiate_generator_bit_0 - 1)) * domain16 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (column20_row22 - global_values.ecdsa_generator_points_y) - column20_row30 * (column20_row6 - global_values.ecdsa_generator_points_x)) * domain16 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/x.
	let value = (column20_row30 * column20_row30 - ecdsa_signature0_exponentiate_generator_bit_0 * (column20_row6 + global_values.ecdsa_generator_points_x + column20_row38)) * domain16 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/y.
	let value = (ecdsa_signature0_exponentiate_generator_bit_0 * (column20_row22 + column20_row54) - column20_row30 * (column20_row6 - column20_row38)) * domain16 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/add_points/x_diff_inv.
	let value = (column20_row1 * (column20_row6 - global_values.ecdsa_generator_points_x) - 1) * domain16 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/copy_point/x.
	let value = (ecdsa_signature0_exponentiate_generator_bit_neg_0 * (column20_row38 - column20_row6)) * domain16 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_generator/copy_point/y.
	let value = (ecdsa_signature0_exponentiate_generator_bit_neg_0 * (column20_row54 - column20_row22)) * domain16 / domain6;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/booleanity_test.
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (ecdsa_signature0_exponentiate_key_bit_0 - 1)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (column20_row8 - column19_row15) - column20_row2 * (column20_row0 - column19_row7)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/add_points/x.
	let value = (column20_row2 * column20_row2 - ecdsa_signature0_exponentiate_key_bit_0 * (column20_row0 + column19_row7 + column20_row16)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/add_points/y.
	let value = (ecdsa_signature0_exponentiate_key_bit_0 * (column20_row8 + column20_row24) - column20_row2 * (column20_row0 - column20_row16)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (ecdsa_signature0_exponentiate_key_bit_neg_0 * (column20_row16 - column20_row0)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/exponentiate_key/copy_point/y.
	let value = (ecdsa_signature0_exponentiate_key_bit_neg_0 * (column20_row24 - column20_row8)) * domain13 / domain5;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column20_row8182 - (column20_row4088 + column20_row8190 * (column20_row8166 - column20_row4080))) / domain18;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/add_results/x.
	let value = (column20_row8190 * column20_row8190 - (column20_row8166 + column20_row4080 + column19_row4103)) / domain18;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/add_results/y.
	let value = (column20_row8182 + column19_row4111 - column20_row8190 * (column20_row8166 - column19_row4103)) / domain18;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column20_row8184 + global_values.ecdsa_sig_config.shift_point.y - column20_row4082 * (column20_row8176 - global_values.ecdsa_sig_config.shift_point.x)) / domain18;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/extract_r/x.
	let value = (column20_row4082 * column20_row4082 - (column20_row8176 + global_values.ecdsa_sig_config.shift_point.x + column20_row4)) / domain18;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	
	// Constraint: ecdsa/signature0/extract_r/x_diff_inv.
	let value = (column20_row8178 * (column20_row8176 - global_values.ecdsa_sig_config.shift_point.x) - 1) / domain18;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
	...
	let value = (column19_row15 * column19_row15 - (column19_row7 * column20_row8186 + global_values.ecdsa_sig_config.alpha * column19_row7 + global_values.ecdsa_sig_config.beta)) / domain18;
	let total_sum = total_sum + *constraint_coefficients.pop_front().unwrap() * value;
...
fn eval_oods_polynomial_inner(
	...
	assert(202 == MASK_SIZE + CONSTRAINT_DEGREE, 'Assert failed');
	return total_sum;
}
